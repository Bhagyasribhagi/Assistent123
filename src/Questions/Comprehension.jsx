...
const Comprehension = ({
  ...
  return (
    <div className="comprehension-container rounded-lg bg-orange-200 p-4">
      <h1 class="font-bold text-transparent text-xl items-center justify-center flex my-3  bg-clip-text bg-gradient-to-r from-purple-600 via-blue-400 to-indigo-500">
        Comphrehension
      </h1>
      ...
      <div className="question-container mt-4">
        {questions.map((question, questionIndex) => (
          <div
            key={questionIndex}
            className="question bg-white p-4 rounded shadow-md mb-4"
          >
            <textarea
              value={question.text}
              onChange={(event) =>
                handleOptionChange(questionIndex, "text", event)
              }
