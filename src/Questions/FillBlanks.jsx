  ...
  return (
    <div className="flex flex-wrap w-full">
      <div className="p-4 text-black   bg-green-300 rounded-lg shadow-md">
        <h1 class="font-bold text-transparent text-xl items-center justify-center flex p-2 bg-clip-text bg-gradient-to-r from-green-300 via-orange-400 to-red-300">
          Cloze Fill Blanks
        </h1>
        <div className="bg-white p-3 rounded-lg">
          ...
          <span className="text-sm font-thin text-red-400">
            Select word in question ans click ctrl+U to make an option
          </span>
