...
export default function SuccessPopup() {
  return (
    <div className="success-popup  p-12 flex-col flex items-center justify-center ">
      <h1 class="font-bold text-transparent text-xl items-center justify-center flex my-3  bg-clip-text bg-gradient-to-r from-green-600 via-orange-400 to-red-500">
