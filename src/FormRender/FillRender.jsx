    ...
    <div className="p-4 flex flex-grow">
      <div className="p-4 bg-white rounded-lg">
        ...
        <div className="text-md lg:text-lg font-medium lg:font-semibold flex flex-wrap">
          Fill in the blanks: This is a {blanks[0]} example with {blanks[1]}{" "}
          blanks.
        </div>
        ...
        <div className="mt-4">
          ...
          <span className="font-thin text-sm text-red-400">
            Drag the options to the blanks below to add the selected options to
            answer
          </span>{" "}
        </div>
      </div>
